...
const Modal = ({isHidden}) => {
  return (
    <div className={`flex  justify-center items-center relative ${isHidden?'hidden':''}`}>
      <div className="flex flex-col max-w-md gap-2 p-6 rounded-md shadow-md bg-pink-400 text-gray-100 absolute -top-full">
